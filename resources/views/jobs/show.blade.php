      ...
      <img src="{{asset('hero-job-image.jpg')}}" style="width: 100%;">
          ...
          <div class="col-lg-8">
            ...
            <div class="col-md-4 p-4 site-section bg-light">
              ...
              <p><a href="{{route('company.index',[$job->company->id,$job->company->slug])}}" class="btn btn-warning" style="width: 100%;">Visit Company Profile</a></p>
              <p><a href="{{route('company.index',[$job->company->id,$job->company->slug])}}" class="btn btn-warning" style="width: 100%;">Apply for this jobs</a></p>
